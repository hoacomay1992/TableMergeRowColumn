      ...
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              Text('1) Đội hình chiến đấu',style: PrimaryFonts.italic(PrimaryFonts.timesNewRoman, 16).copyWith(fontWeight: FontWeight.bold),),
              Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                      Column(
        ...
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('2) Thông báo khí tượng trung bình',style: PrimaryFonts.italic(PrimaryFonts.timesNewRoman, 16).copyWith(fontWeight: FontWeight.bold),),
            Container(
                width: width * 15,
                height: height * 8,
